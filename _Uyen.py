...
# Form implementation generated from reading ui file '_Uyen.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setStyleSheet("background-color: rgb(255, 84, 201);")
...
"}")
        ...
        self.gridLayout.addWidget(self.push_zero, 6, 0, 1, 2)
...
"}")
        ...
        self.gridLayout.addWidget(self.push_clear, 1, 1, 1, 1)
        self.name = QtWidgets.QLabel(self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(8)
        self.name.setFont(font)
        self.name.setStyleSheet("color: rgb(255, 255, 127);\n"
"\n"
"")
